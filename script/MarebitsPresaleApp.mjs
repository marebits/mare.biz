...
function updateButtons() { (async function() { console.log(this); console.log(_privates.get(this)); _privates.get(this).elements.buttons.addToMetamask.disabled = !(this.web3.isConnected && await this.web3.isTargetChain); })().catch(console.error); }
